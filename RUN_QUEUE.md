...
- [ ] AGREEMENT_SPEC Phase AG-3 — version bumps: seed refuses reacceptRequired bumps without counselReviewed; day-0 notice email; dashboard banner → modal after 30 days; operator writes 428 agreement_required except sign/check-in/bookings; courses sheet + Overview show overdue; mark_live refuses on overdue (no migration, medium).
