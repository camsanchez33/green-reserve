...
- [x] ONBOARDING_V2_SPEC Phase V5 — inquiry full page at /admin/inquiries/[id] replaces the drawer: header + action toolbar, full-width tabs, HUMAN-readable sheet tab (label/value maps, sections, coherent-answers filtering, amber "not provided"), stage-driven "Next steps" card, delete drawer (medium-big, no migration) — f8ddfad
