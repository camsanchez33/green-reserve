...
// the wording of these; when it does, both surfaces move together. SD-6
// (2026-09-11) reworded the walk-in and visibility answers to what is true.
export const HOME_FAQ: { q: string; a: string }[] = [
  ...
  { q: 'Can we still take phone and walk-in bookings?', a: 'Yes — nothing about how you take them changes. Walk-ins and phone bookings stay in your shop as they are today; on your GreenReserve sheet you can block or add tee times so online golfers only ever see what is really open. Entering walk-ins into the sheet itself is coming.' },
  ...
  { q: 'Can we control who sees our tee times?', a: 'Your booking page has its own link, and once you are live search engines can find it. There is no marketplace or directory pushing golfers to other courses — you decide where else to promote your page.' },
];
