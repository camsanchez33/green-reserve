...
import {
  ...
  RefreshCw, Mail, Ban, Plus, Trash2, Wrench, Power, ArrowUpRight,
} from 'lucide-react';
...
export default function InquiriesPage() {
  ...
  const visibleInqs = inquiryView === 'active' ? activeInqs : pastInqs;
    ...
    <div className="min-h-screen bg-gray-950 text-white flex">
      ...
      <div className="ml-56 flex-1 min-h-screen">
        <div className="px-8 py-7 max-w-6xl">
          ...
          <InquiryToggle view={inquiryView} onSwitch={setInquiryView} activeCount={activeInqs.length} pastCount={pastInqs.length}/>
                ...
                <div className="px-5 py-4 flex items-start gap-4">
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-xs text-gray-600 mt-0.5 flex items-center gap-2">
                      <span>{inq.city}, {inq.state}</span><span>·</span>
                      <span className="capitalize">{inq.courseType}</span><span>·</span>
...
const _unused = { fmtMoney, ArrowUpRight, Ban, Plus };
void _unused;
