...
const raw = { v: 2, items: {
  ...
  season_hours: { fields: { seasonOpen: '2026-04-01', seasonClose: 'soon', daysOpen: [0, 6, 6, 9, 'x'] }, note: '' },
...
check('date: valid kept, invalid dropped', v.items.season_hours.fields.seasonOpen === '2026-04-01' && v.items.season_hours.fields.seasonClose === undefined);
...
check('flatSummaries: one line per captured item', Object.keys(flat).length === 4, JSON.stringify(Object.keys(flat)));
