---
description: GreenReserve feature builder. Use when writing new features, refactoring code, rewriting pages, or making improvements to the GreenReserve codebase.
---
...
6. **For large files (>200 lines):** write to file, check line count, validate parse. If truncated, append missing closing tags.
